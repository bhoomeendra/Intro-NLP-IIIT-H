...
class Tokenizer():
    ...
    def __init__(self,pre_embedding_path,doc_path):
    ...
    def clean(self, text):
        ...
        text  = text.lower()
        for rule in tqdm(self.order,desc='Cleaning:'):
...
if __name__=='__main__':
	...
	token = Tokenizer(pre_embedding_path = '../../Embedding/glove.6B.50d.txt',
					  doc_path='../data/Pride and Prejudice - Jane Austen.txt')
